...
sabio.page.startup = function () {
    ...
    $("#commentsForm").on("click", sabio.page.handlers.onAddComment);
    $("cmdReplyButton").on("click", sabio.page.handlers.onReplyButton);
    $("#replyForm").on("submit", sabio.page.handlers.onReplyAddComent);
...
sabio.page.handlers.onAddComment = function (event) {
    ...
    var commentsForm = $("#commentsForm").serializeAray();
